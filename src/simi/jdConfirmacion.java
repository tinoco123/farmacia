...
public class jdConfirmacion extends javax.swing.JDialog {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        System.out.println(datos.get("cantidad"));        
        System.out.println(datos.get("nombre"));
        System.out.println(datos.get("tipoProducto"));
        System.out.println(datos.get("sucursal"));
        System.out.println(datos.get("proveedor"));

        Pedido pedido = new Pedido(datos.get("nombre"), datos.get("tipoProducto"), Integer.parseInt(datos.get("cantidad")), datos.get("sucursal"), datos.get("proveedor"));
